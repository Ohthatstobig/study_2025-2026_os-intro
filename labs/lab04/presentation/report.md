...
![""](image/scr2.png){#fig:02 width=70%}

установка Node.js (Рис 3 и 4)

![""](image/scr3.png){#fig:03 width=70%}

![""](image/scr4.png){#fig:04 width=70%}

Настройка Node.js (Рис 5)

![""](image/scr5.png){#fig:05 width=70%}

При помощи программы commitizen устанавливаем git-cz (Рис 6)

![""](image/scr6.png){#fig:06 width=70%}

Данная программа используется для помощи в создании логов.(Рис 7)

![""](image/scr7.png){#fig:07 width=70%}
